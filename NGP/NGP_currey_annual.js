...
for(i; i < years.length; i++){
  ...
  if(years[i] < 2006){
    ...
    Export.image.toDrive({
      image: prMed,
      description: 'NGP_' + years[i] + '_precip_mm_1km_' + scenarios[0],
      folder:'NGP_currey',
      crs: 'EPSG:4326', 
      region: NGP,
    ...
    Export.image.toDrive({
      image: tMed,
      description: 'NGP_' + years[i] + '_avgTemp_C_1km_' + scenarios[0],
      folder:'NGP_currey',
      crs: 'EPSG:4326', 
      region: NGP,
      maxPixels: 40000000000,
    ...
    for(k; k < scenarios.length; k++){ 
      ...
      Export.image.toDrive({
        image: prMed,
        description: 'NGP_' + years[i] + '_precip_mm_1km_' + scenarios[k],
        folder:'NGP_currey',
        crs: 'EPSG:4326', 
        region: NGP,
        maxPixels: 40000000000,
      ...
      Export.image.toDrive({
        image: tMed,
        description: 'NGP_' + years[i] + '_avgTemp_C_1km_' + scenarios[k],
        folder:'NGP_currey',
        crs: 'EPSG:4326', 
        region: NGP,
        maxPixels: 40000000000,
